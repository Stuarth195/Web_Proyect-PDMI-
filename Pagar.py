...
class Pagos:
    ...
    def menu_compra(self, user):
        ...
        label_seleccion = tk.Label(ventana_Compra, text=f"Seleccionaste: {var.get()}", font=("Verdana", 16), fg="black",
                                   bg="white")
        ...
        Fondo = tk.Canvas(ventana_Compra, width=1000, height=600, bg="grey")
        Fondo.pack()

        # Mostrar el total a pagar
        Total_a_pagar = tk.Label(ventana_Compra, text=str(self.total) + "$", font=("Verdana", 20), fg="black",
                                 bg="white")
        ...
        LabelTarjeta = tk.Label(ventana_Compra, text="Seleccionar metodo de pago", font=("Verdana", 20), fg="black",
                                bg="white")
        LabelTarjeta.place(x=5, y=100)

        # Crear los Radio Buttons para las opciones de pago
        rb1 = tk.Radiobutton(ventana_Compra, text=OpcionesPago[0], variable=var, value=OpcionesPago[0],
                             font=("Verdana", 14), fg="black", bg="white",
                             command=lambda: actualizar_seleccion(OpcionesPago[0]))
        rb1.place(x=5, y=140)
        rb2 = tk.Radiobutton(ventana_Compra, text=OpcionesPago[1], variable=var, value=OpcionesPago[1],
                             font=("Verdana", 14), fg="black", bg="white",
                             command=lambda: actualizar_seleccion(OpcionesPago[1]))
        rb2.place(x=5, y=180)
        rb3 = tk.Radiobutton(ventana_Compra, text=OpcionesPago[2], variable=var, value=OpcionesPago[2],
                             font=("Verdana", 14), fg="black", bg="white",
        ...
        Entry1 = tk.Entry(ventana_Compra, width=50)
        Entry1.place_forget()  # Esto asegura que no se vea al inicio

        Entry2 = tk.Entry(ventana_Compra, width=50)
        Entry2.place_forget()  # Esto asegura que no se vea al inicio

        Tarjeta1 = tk.Label(ventana_Compra, text="Ingrese su numero de tarjeta", font=("Verdana", 20), fg="black",
                            bg="white")
        Tarjeta1.place_forget()

        Tarjeta2 = tk.Label(ventana_Compra, text="Ingrese el pin de la tarjeta", font=("Verdana", 20), fg="black",
                            bg="white")
        Tarjeta2.place_forget()

        Simpe = tk.Label(ventana_Compra, text="Digite Numero de Telefono", font=("Verdana", 20), fg="black", bg="white")
        Simpe.place_forget()

        Efectivo1 = tk.Label(ventana_Compra, text="Nombre y apellidos de la \n persona", font=("Verdana", 20),
                             fg="black",
                             bg="white")
        Efectivo1.place_forget()
        # /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        LabelEntrega = tk.Label(ventana_Compra, text="Seleccionar metodo entrega", font=("Verdana", 20), fg="black",
                                bg="white")
        LabelEntrega.place(x=5, y=300)

        LabelLocacion = tk.Label(ventana_Compra, text="Recoger en local o fabrica", font=("Verdana", 16), fg="black",
                                 bg="white")
        LabelLocacion.place(x=5, y=340)

        ConfirmarEnLocacion = tk.Button(ventana_Compra, text="Confirmar", font=("Verdana", 16), bg="white", fg="black",
        ...
        if user != "User0000":
            ...
            DireccionUser = tk.Entry(ventana_Compra, width=50, font=("Verdana", 16))
            DireccionUser.place(x=5, y=490)

            ConfirmarDireccion = tk.Button(ventana_Compra, text="Confirmar", font=("Verdana", 16), bg="white",
